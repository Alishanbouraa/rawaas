...
namespace QuickTechSystems.WPF
{
    public partial class App : System.Windows.Application
    {
        ...
        private void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<AttendanceManagementViewModel>();
            services.AddScoped<SalaryManagementViewModel>();
            services.AddScoped<MonthlySummaryViewModel>();
            ...
            services.AddTransient<AttendanceManagementWindow>();
            services.AddTransient<SalaryManagementWindow>();
            services.AddTransient<MonthlySummaryWindow>();
        }
